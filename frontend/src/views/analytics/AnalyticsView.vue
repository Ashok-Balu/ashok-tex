...
/* Responsive */
@media (max-width: 1280px) { .kpi-grid { grid-template-columns: repeat(3, 1fr); } .hc-grid { grid-template-columns: repeat(2, 1fr); } .wf-kpis { grid-template-columns: repeat(3, 1fr); } }
@media (max-width: 1024px) { .dual { grid-template-columns: 1fr; } .gauge-row { grid-template-columns: 1fr; } .fc-grid { grid-template-columns: repeat(2, 1fr); } .arc-section { flex-direction: column; align-items: center; } .os-grid { grid-template-columns: repeat(2, 1fr); } .yarn-grid { grid-template-columns: repeat(2, 1fr); } .quality-kpis { grid-template-columns: repeat(2, 1fr); } .recent-grid { grid-template-columns: 1fr; } .wf-kpis { grid-template-columns: repeat(2, 1fr); } .sr-grid { grid-template-columns: repeat(2, 1fr); } }
@media (max-width: 768px) { .ap { padding: 12px; } .kpi-grid { grid-template-columns: 1fr 1fr; } .hc-grid { grid-template-columns: 1fr; } .fc-grid { grid-template-columns: 1fr; } .metrics-row { grid-template-columns: 1fr 1fr; } .hero { padding: 20px; } .hero-content { flex-direction: column; align-items: flex-start; } .pl-flow { flex-direction: column; } .yarn-grid { grid-template-columns: 1fr 1fr; } .os-grid { grid-template-columns: 1fr 1fr; } .wf-kpis { grid-template-columns: repeat(2, 1fr); } .sr-grid { grid-template-columns: 1fr; } .dc-summary { flex-wrap: wrap; gap: 10px; } .dc-stat { flex: unset; width: calc(50% - 5px); } }
</style>
