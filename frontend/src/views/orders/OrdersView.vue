...
const cols = [
  {
    ...
    cellRenderer: p => `<a href="${getOrderDetailHref(p.data)}" style="display:block;color:#1A2744;font-weight:700;text-decoration:none;white-space:normal;overflow-wrap:anywhere;line-height:1.35">${p.value || '-'}</a>`,
  },
