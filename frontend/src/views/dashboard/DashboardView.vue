<template>
  <div class="dashboard-page">
    ...
    <div class="section-card">
      ...
      <div v-if="companyGroups.length" class="company-list">
        <div v-for="company in companyGroups" :key="company.companyId + '-' + company.companyName" class="company-card">
          <!-- Company Header -->
          <div
    ...
    <div class="section-card">
      <div class="section-header simple">
        <div class="section-header-left">
          <div class="section-icon">
            <v-icon size="20" color="primary">mdi-clipboard-text-outline</v-icon>
          </div>
          <div>
            <h2 class="section-title">{{ t('recentOrders') }}</h2>
            <p class="section-sub">Last {{ recentOrders.length }} orders</p>
          </div>
        </div>
        <v-btn variant="tonal" color="primary" size="small" to="/orders" append-icon="mdi-arrow-right">View All</v-btn>
      </div>
