...
const routes = [
  { path: '/login', name: 'login', component: () => import('@/views/auth/LoginView.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'financial-intelligence', name: 'financial-intelligence', component: () => import('@/views/financial/FinancialIntelligenceView.vue') },
      { path: 'financial-intelligence/debts/:id', name: 'financial-intelligence-debt-detail', component: () => import('@/views/financial/DebtDetailView.vue') },
    ],
  },
