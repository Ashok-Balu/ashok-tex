...
- Backend: https://ashok-tex-backend.onrender.com
...
## 3) MongoDB password
If you update the Atlas database user password or change the database user, update the full `MONGODB_URI` value in Render immediately.
...
> `https://ashok-tex-backend.onrender.com/api/health`
